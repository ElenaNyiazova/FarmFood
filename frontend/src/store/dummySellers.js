export const dummySellers = {
  ...
  entities: {
    ...
    '02': {
      ...
      seller_categories: ['Fruits', 'Vegetables', 'Dairy and eggs'],
      seller_products: [
        'apple',
        'pear',
        'potato',
